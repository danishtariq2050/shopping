                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            ...
                                            <div class="product__discount__item__text">
                                                <span>{{$dp->category->name}}</span>
                                                <h5><a href="#">{{$dp->name}}</a></h5>
                                                <div class="product__item__price">PKR. {{number_format($dp->discountprice)}} <span>PKR. {{number_format($dp->price)}}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5>PKR. {{number_format($p->price)}}</h5>
                                    </div>
                                </div>
                            </div>
                        @endforeach
